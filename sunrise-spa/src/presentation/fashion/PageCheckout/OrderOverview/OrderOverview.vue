...
<template>
  <div class="your-order-area">
    ...
    <div class="your-order-wrap gray-bg-4">
      <div v-if="cart" class="your-order-info-wrap">
      ...
      <!-- v-if="!paid" -->
      <div v-if="cart" class="checkout-shipping-content">
      ...
      <PaymentMethod />
      <div v-if="cart" class="your-order-info order-total">
        <ul>
          <li class="bold-text">
            {{ t('total') }}
            <span
              ><BasePrice
                :price="{
                  value: cart.taxedPrice.totalGross,
                }"
            /></span>
          </li>
        </ul>
