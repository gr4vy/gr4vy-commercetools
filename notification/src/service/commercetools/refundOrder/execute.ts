...
const refundOrder = async (
    ...
    const refund = {amount: orderRefundDetails.refundAmount, transactionId : orderRefundDetails.paymentTransactionId}
    ...
    if (transactionRefundResponse && transactionRefundResponse.status == GR4VY.TRANSACTION.REFUND_SUCCEEDED) {
