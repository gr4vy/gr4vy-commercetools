...
import {PaymentConfig, Refund, TransactionRefund} from "./../../types"

export const transactionRefund = async ({ refund, paymentConfig }: {refund:Refund, paymentConfig:PaymentConfig}) => {
  ...
  const transactionRefundParams = {
    amount: refund.amount, transactionId: refund.transactionId
  }
